...
@Slf4j
public class CustomerAggregator implements Aggregator<String, Order, Customer> {
    ...
    public CustomerAggregator(String rejectOrderTopic, Properties properties) {
        this.rejectOrderTopic = rejectOrderTopic;
        orderResponseProducer = ConfigHelper.createGenericJsonProducer(properties);
    }

    @Override
    public Customer apply(String customerId, Order order, Customer customer) {
